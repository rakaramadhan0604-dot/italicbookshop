...
<html lang="id">
  <head>
    ...
    <meta name="description" content="Telusuri seluruh katalog buku sewa Italic, lengkap dengan filter genre dan pencarian judul." />

    <!-- Open Graph / social sharing -->
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Italic" />
    <meta property="og:title" content="Katalog — Italic" />
    <meta property="og:description" content="Telusuri seluruh katalog buku sewa Italic, lengkap dengan filter genre dan pencarian judul." />
    <meta property="og:url" content="https://www.italic.co.id/catalog.php" />
    <meta property="og:image" content="https://www.italic.co.id/assets/og-image.jpg" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:locale" content="id_ID" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Katalog — Italic" />
    <meta name="twitter:description" content="Telusuri seluruh katalog buku sewa Italic, lengkap dengan filter genre dan pencarian judul." />
    <meta name="twitter:image" content="https://www.italic.co.id/assets/og-image.jpg" />
    <title>Katalog — Italic</title>
  ...
  <body>
    ...
    <main id="main">
      <section class="section-tight" style="padding-top:2.5rem;">
        <div class="wrap">
          <p class="eyebrow">Katalog Lengkap</p>
          <h1 style="font-size:clamp(2rem,4vw,3.2rem);">Jelajahi Koleksi Buku Kami</h1>
          <p class="lede mt-1">Judul terkurasi dari fiksi literer, romance, hingga fantasi epik. Setiap kartu menampilkan harga sewa per hari dan jumlah eksemplar yang tersedia saat ini.</p>
        </div>
      </section>
      ...
      <section class="section-tight">
        <div class="wrap">
          <div class="search-row">
            <input type="search" id="search-input" placeholder="Cari judul atau penulis…" aria-label="Cari buku" />
          </div>
          <div class="filter-bar" id="filter-bar">
            <button type="button" class="is-active" data-genre="all">Semua</button>
            <button type="button" data-genre="Fiction">Fiction</button>
            <button type="button" data-genre="Romance">Romance</button>
          </div>
          <div class="cat-grid" id="catalog-grid"></div>
        </div>
      </section>
    </main>
    ...
    <script src="assets/js/script.js?v=<?php echo @filemtime(__DIR__ . '/assets/js/script.js') ?: '1'; ?>"></script>
    ...
    <script>
      (function () {
        ...
        function apply() {
          ...
          let list = ITALIC_BOOKS.filter((b) => activeGenre === "all" || b.genre === activeGenre);
          if (term) {
            list = list.filter((b) => b.title.toLowerCase().includes(term) || b.author.toLowerCase().includes(term));
          }
          renderBookTiles(list, grid);
        }

        filterBar.querySelectorAll("button").forEach((btn) => {
          if (btn.dataset.genre === activeGenre) btn.classList.add("is-active");
